...
def _ensure_ico():
    ico_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "images", "icons", "mbtl.ico")
...
def _register_filetype(ext, type_name, description, ico_path):
    ...
    Returns: True/False
    """
    importer_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "importer.pyw")
